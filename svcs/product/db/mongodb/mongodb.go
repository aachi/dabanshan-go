...
func init() {
	flag.StringVar(&name, "mongo-user", os.Getenv("MONGOUSER"), "Mongo user")
	flag.StringVar(&password, "mongo-password", os.Getenv("MONGOPWD"), "Mongo password")
	flag.StringVar(&host, "mongo-host", os.Getenv("MONGOHOST"), "Mongo host")
}
